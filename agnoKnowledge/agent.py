...
agent = Agent(
    ...
    instructions=["you are a helpful assistant",
                  "whenever asked about react interview question, use the knowledge base to get the context",
...
agent.print_response("Can you answer about lifecycle methods in React?")